...
def export_solution_to_png(Lx,Ly,nnx,nny,nelx,nely,x,y,u,v,q,exx,eyy,exy,ee,eta,\
   ...
   onePlot(axes,fig,u_temp,   0, 0, "$v_x$",                  "x", "y", extent,  Lx,  Ly, 'seismic_r')
   onePlot(axes,fig,v_temp,   0, 1, "$v_y$",                  "x", "y", extent,  Lx,  Ly, 'seismic_r')
   onePlot(axes,fig,p_temp,   0, 2, "$p$",                    "x", "y", extent,  Lx,  Ly, 'magma_r')
   onePlot(axes,fig,exx_temp, 1, 0, "$\dot{\epsilon}_{xx}$",  "x", "y", extent,  Lx,  Ly, 'jet')
   onePlot(axes,fig,eyy_temp, 1, 1, "$\dot{\epsilon}_{yy}$",  "x", "y", extent,  Lx,  Ly, 'jet')
   onePlot(axes,fig,exy_temp, 1, 2, "$\dot{\epsilon}_{xy}$",  "x", "y", extent,  Lx,  Ly, 'jet')
   onePlot(axes,fig,ee_temp,  2, 0, "$\dot{\epsilon}_{eff}$", "x", "y", extent,  Lx,  Ly, 'jet')
   onePlot(axes,fig,eta_temp, 2, 1, "$\eta$",                 "x", "y", extent,  Lx,  Ly, 'gist_rainbow')
